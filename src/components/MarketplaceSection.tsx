        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="animate-fade-up">
            ...
            <div className="prose prose-lg text-gray-700 max-w-xl">
              ...
              <Link to="/about" className="gold-button inline-block">Explore About Us</Link>
            </div>
          </div>
          <div className="hidden md:block">
            <div className="relative">
              <img src="/lovable-uploads/61ad7a88-c8e2-42f6-b3b1-567415b3c17e.png" alt="Naaz Marketplace" className="rounded-lg shadow-lg object-cover w-full h-[400px]" />
