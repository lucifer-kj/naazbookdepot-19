    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-16 px-4">
        <div className="container mx-auto">
          <h1 className="text-4xl font-playfair font-bold text-naaz-green mb-8">Islamic Essentials</h1>
          <p className="text-lg mb-8">
            Our collection of premium Islamic accessories and essentials from Naaz Essentials.
          </p>
