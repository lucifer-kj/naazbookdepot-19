        ...
        <div className="container mx-auto max-w-2xl">
          <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
            <div className="text-center mb-8">
              <h1 className="text-xl md:text-2xl font-playfair font-bold text-naaz-green mb-4">
                Complete Your UPI Payment
              </h1>
              <div className="bg-naaz-gold/10 p-4 rounded-lg mb-4">
                <p className="text-naaz-green font-semibold text-base md:text-lg">
              ...
              <p className="text-naaz-green font-medium mb-2 text-sm md:text-base">
            ...
            <div className="flex flex-col items-center relative mb-6">
              <img 
                ...
                className="rounded-xl w-48 h-48 md:w-52 md:h-52 border-0 shadow-sm"
                style={{ background: 'white', objectFit: 'contain' }}
              />
              <img 
                src={brandLogo}
                alt="Brand Logo"
                className="absolute top-1/2 left-1/2 w-10 h-10 md:w-12 md:h-12 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white border border-gray-200 shadow-sm"
              />
            </div>
            ...
            <div className="flex justify-center mb-4">
              <a
                href={upiUrl}
                className="inline-block bg-naaz-green text-white px-4 md:px-6 py-3 rounded-lg hover:bg-naaz-green/90 transition-colors text-sm md:text-base"
            ...
            {!showButtons && (
              <div className="flex items-center justify-center mb-6">
                <Clock className="text-naaz-gold mr-2" size={20} />
                <span className="text-base md:text-lg font-semibold text-naaz-green">
                  {countdown} seconds
                </span>
              </div>
            )}
            ...
            {showButtons && (
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <button
                  ...
                  className="flex-1 flex items-center justify-center border border-naaz-green text-naaz-green py-3 rounded-lg hover:bg-naaz-green/5 transition-colors text-sm md:text-base"
                >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center bg-naaz-green text-white py-3 rounded-lg hover:bg-naaz-green/90 transition-colors disabled:opacity-50 text-sm md:text-base"
                >
            ...
            <div className="flex flex-col items-center mt-3">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-sm md:text-base"
              >
                <Smartphone size={18}/>
