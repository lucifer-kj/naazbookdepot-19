  ...
  return (
    <div className="min-h-screen bg-naaz-cream">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-7xl font-playfair font-bold text-white mb-6 animate-fade-in transform translate-x-0 opacity-100 transition-all duration-1000 drop-shadow-2xl">
              Naaz Book Depot
              <span className="block text-2xl md:text-3xl text-naaz-gold mt-2">Kolkata</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
              <Link 
                to="/about" 
                className="group bg-naaz-gold text-naaz-green px-8 py-4 rounded-xl font-bold hover:bg-naaz-gold/90 transition-all duration-300 text-center transform hover:scale-105 hover:shadow-2xl"
              >
              ...
              <Link 
                to="/books" 
                className="group border-2 border-white text-white px-8 py-4 rounded-xl font-bold hover:bg-white hover:text-naaz-green transition-all duration-300 text-center transform hover:scale-105"
              >
                <span className="flex items-center justify-center gap-2">
                  Explore Books
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-12">
              {featuredBooks.map((book, index) => (
                <div 
                  key={book.id}
                  className={`group bg-white rounded-2xl shadow-lg p-6 text-center transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 ${
                    index === currentProduct ? 'ring-2 ring-naaz-gold transform scale-105' : ''
                  }`}
                >
                  <div className="relative overflow-hidden rounded-xl mb-6">
                    <img 
                      src={book.image} 
                      alt={book.title}
                      className="w-40 h-48 object-cover mx-auto transition-transform duration-500 group-hover:scale-110"
                    />
            ...
            <div className="flex justify-center mt-8 md:hidden gap-4">
              <button 
                onClick={prevProduct}
                className="bg-naaz-green/80 text-white p-3 rounded-full hover:bg-naaz-green transition-colors"
              >
                <ChevronLeft size={24} />
              </button>
              <button 
            ...
            <div className="text-center mt-12">
              <Link 
                to="/books" 
                className="group bg-naaz-gold text-white px-8 py-4 rounded-xl font-semibold hover:bg-naaz-gold/90 transition-all duration-300 inline-flex items-center gap-3 transform hover:scale-105"
              >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <Link 
                to="/books" 
                className="group-hover:bg-naaz-green group-hover:text-white text-naaz-gold border border-naaz-gold px-6 py-3 rounded-xl font-semibold transition-all duration-300 inline-flex items-center gap-2"
              >
                Browse Collection 
            ...
            <div className="group bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden">
              ...
              <Link
                to="/perfumes"
                className="text-gray-500 border border-gray-300 px-6 py-3 rounded-xl font-semibold inline-flex items-center gap-2 hover:bg-gray-50 transition-all duration-300"
              >
                Get Notified
                <Mail size={18} />
              </Link>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-naaz-green to-naaz-green/90 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=\"40\" height=\"40\" viewBox=\"0 0 40 40\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%23ffffff\" fill-opacity=\"0.03\"%3E%3Cpath d=\"M20 20c0-11.046-8.954-20-20-20v20h20z\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
